...
RSpec.describe "/replies", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get replies_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Reply" do
        expect {
          post replies_url,
               params: { reply: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Reply" do
        expect {
          post replies_url,
               params: { reply: invalid_attributes }, as: :json
        }.to change(Reply, :count).by(0)
      end

      it "renders a JSON response with errors for the new reply" do
        post replies_url,
             params: { reply: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested reply" do
      reply = Reply.create! valid_attributes
      expect {
        delete reply_url(reply), headers: valid_headers, as: :json
      }.to change(Reply, :count).by(-1)
    end
  end
end
